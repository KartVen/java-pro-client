...
@AndroidEntryPoint
public class LinksFragment extends Fragment implements ActivityUtility {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(LinksFragmentViewModel.class);
    }
    ...
    private void initRecyclerView() {
        RecyclerView recyclerView = binding.fragmentLinksRecyclerView1;
