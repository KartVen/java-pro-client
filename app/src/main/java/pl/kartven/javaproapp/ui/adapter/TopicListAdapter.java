...
public class TopicListAdapter extends RecyclerView.Adapter<TopicListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater
                ...
                .inflate(R.layout.view_holder_topic_list, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.topic_list_text_view_1);
            description = itemView.findViewById(R.id.topic_list_text_view_2);
            logo = itemView.findViewById(R.id.topic_list_image_view_1);
        }
